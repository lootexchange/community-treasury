...
const CreateProposalPage = () => {
  ...
  return (
    <Section
      bgColor="transparent"
      fullWidth={false}
      className={classes.createProposalPage}
    >
      ...
      <Col lg={{ span: 8, offset: 2 }} className={classes.createProposalForm}>
        ...
        <Alert variant="secondary" className={classes.voterIneligibleAlert}>
          <b>Tip</b>: Add one or more transactions and describe your proposal
          for the community. The proposal cannot modified after submission, so
